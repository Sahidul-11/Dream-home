...
const LogIn = () => {
    ...
    const { signInUser, googleLogIn, setLoading,gitHubLogIng } = Context();
        ...
        <div>
            ...
            <div className=" w-full md:w-2/3 lg:w-2/4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800 mx-auto">
                ...
                <div className="flex items-center w-full my-4">
                    ...
                    <div className="w-full"><p className="px-3 dark:text-gray-600 bg-gray-400 text-center bg-opacity-40 p-2 rounded-lg">OR LOGIN IN WITH</p></div>
                    <hr className="w-full dark:text-gray-600" />
                </div>
                <div className="flex flex-col lg:flex-row justify-between gap-4 text-white">
                    ...
                    <button onClick={HandleGithub} aria-label="Login with GitHub" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 bg-[#dd4b39] hover:bg-white hover:text-[#dd4b39] focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                    ...
                    <button aria-label="Login with Twitter" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 bg-[#00acee] hover:bg-white hover:text-[#00acee] focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
