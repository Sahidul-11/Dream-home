            ...
            <div className=" w-full lg:w-1/3 mx-auto">
                <section className="bg-white dark:bg-gray-900 mx-auto">
                    <div className="container flex items-center min-h-screen px-6 py-12 mx-auto">
                        <div>
                            <p className="text-4xl font-bold text-blue-500 dark:text-blue-400 ">404 error</p>
                            ...
                            <Link to="/">  <button className="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700">
